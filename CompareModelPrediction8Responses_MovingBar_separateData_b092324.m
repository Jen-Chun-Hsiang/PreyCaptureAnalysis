...
recording_name = 'a092324'; % b092324
response_name = 'c082924'; % a082924
...
%% save
if is_blurry
    save_file_name = sprintf('%s_%s_moving_bar_simulated_%d_burry%0.3G.mat', recording_name,...
        response_name, implement_case_id, blurry_length);
else
