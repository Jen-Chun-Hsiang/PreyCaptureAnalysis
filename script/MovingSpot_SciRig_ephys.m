...
for b = 1:IN.repeat
    ...
    for i = 1:nStim
        ...
        Str = 1;
        tic
        while toc*speed_adj(stim_ids(2)) <= one_side_distance*2
            posi_x = CeterX+start_x+toc*mov_x;
            posi_y = CeterY+start_y+toc*mov_y;
            ...
            if Str  == 1
                ...
                ii = ii +1;
                Str = 0;
                fprintf('\t Diameter: %d Speed: %d Direction:%d \n', IN.diameters(stim_ids(1)),...
...
EndTime = cgflip(contrast_bg,contrast_bg,contrast_bg);
