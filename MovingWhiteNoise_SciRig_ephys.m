function OUT = MovingWhiteNoise_SciRig_ephys(IN,OLED,DIO)
...
OUT.startT = cgflip;
if ~OLED.IsDebug
    UniqueTrigger(IN.uniqueTrigger, DIO);
end
...
for b = 1:nBlock
    ...
    if RepeatBlockIds(b)
        ...
        for i = 1:nFrame
            ...
            cgloadarray(1, nCols, nRows,[Stim_int(:),Stim_int(:),Stim_int(:)], OLED.width, OLED.height);
