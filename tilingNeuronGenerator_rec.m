function positions = tilingNeuronGenerator_rec(num_neuron, patch_length_h, patch_length_w, initial_fac)
if nargin  < 4
    initial_fac = 4;
end
pos = rand(num_neuron*initial_fac, 2).*[patch_length_h, patch_length_w];
